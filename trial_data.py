...
TRIALS = {   'TAX-2026-001': {   'tax_id': 'TAX-2026-001',
    ...
    "TAX-2026-008": {
        ...
        "phase": "Phase 2",
        "condition": "Moderately Active Ulcerative Colitis",
        "condition_type": [],
        "design": "See protocol",
        "duration": "See protocol",
        "ind_number": "125154",
        "protocol_date": "2026-06-28",
        "latest_amendment": "Version 1.0",
        "latest_amendment_date": "2026-06-28",
        "countries": ["North America", "Europe", "Asia Pacific", "Middle East", "Africa"],
        "patients_screened": None,
        "patients_randomized": None,
        ...
        "primary_endpoint": "Clinical remission after 52 weeks of treatment with etrasimod.",
        "pdf_filename": "TAX-2026-008_GLADIATOR-UC_APD334-210.pdf",
        "inclusion_criteria": ["See protocol"],
        "exclusion_criteria": ["See protocol"],
        "amendment_history": [{"version": "Version 1.0", "date": "2026-06-28", "patients_at_time": "0"}],
        "tmf_documents": {
            "Protocol (Final)": {"status": "Complete", "date": "2026-06-28", "version": "v1.0"},
